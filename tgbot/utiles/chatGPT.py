...
async def create_psychological_portrait(smilesDict: {}) -> str:
    ...
    chat_completion_resp = await openai.ChatCompletion.acreate(
                ...
                {"role": "system", "content": 'Пользователь в течении недели отправлял телеграм-боту смайлики, '
                                              ...
                                              'рекомендации как улучшить свое психологическое здоровье. Сообщение '
                                              'начинаешь со слов: "Привет! Я составил твой психологический портрет за '
                                              'последние 7 дней, в которых ты выставлял смайлики." При кратком '
                                              'описании каждого дня дату указывай в следующем виде: "(число) (месяц в '
                                              'в текстовом формате)". Общайся с пользователем как с другом.'
