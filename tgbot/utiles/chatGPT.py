...
# text1Week = 'Пользователь в течении недели отправлял телеграм-боту смайлики, '
...
#                                               'пользователю его психологический портрет и обязательно даёшь ему '
#                                               'рекомендации как улучшить свое психологическое здоровье, также ёмко, как и портрет. '
#                                               'Сообщение начинаешь со слов: "Привет! Я составил твой психологический '
#                                               'портрет за последние 7 дней, в которых ты выставлял смайлики.". '
#                                               'Общайся с пользователем как с другом. Описывать каждую дату со '
#                                               'смайликами не нужно.'
...
async def create_psychological_portrait_day(smilesDay: str) -> str:
    """
    Генерирует психологический портрет за день.
